// ⚠️ 자닥신 — placeholder 데이터. 의료팀 검수 후 최종 확정 필요.
...
export const zadaxinData: TreatmentDetail = {
  ...
  heroImage: `${BASE}clinic_onco.jpeg`,  // TODO: 실제 자닥신 사진
  heroVideoUrl: "",
  heroVideoLabel: "자닥신 치료 안내 영상",
  ...
  visualCardsTitle: "자닥신이 주는 효과",  // TODO
  visualCards: [
  ...
  consultQuestion: "자닥신 치료가 나에게 적합한지 궁금하신가요?",  // TODO

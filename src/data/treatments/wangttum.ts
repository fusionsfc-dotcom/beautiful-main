...
export const wangttumData: TreatmentDetail = {
  ...
  heroImage: `${BASE}te_1.jpeg`,      // TODO: 실제 왕뜸 시술 사진으로 교체
  heroVideoUrl: "",
  heroVideoLabel: "왕뜸 치료 과정 영상 보기",
  ...
  visualCardsTitle: "왕뜸이 주는 놀라운 효과",
  visualCards: [
    {
      number: "01",
      title: "면역력 강화",
      subtitle: "면역 기능 활성화",
      image: `${BASE}yoga_s.jpeg`,    // TODO: 왕뜸 효과 사진 1
    },
    {
      number: "02",
      title: "체온 상승",
      subtitle: "혈액순환 개선",
      image: `${BASE}hero_img.jpeg`,  // TODO: 왕뜸 효과 사진 2
    },
    {
      number: "03",
      title: "통증 완화",
      subtitle: "근육 이완 및 회복",
      image: `${BASE}room_pa.jpeg`,   // TODO: 왕뜸 효과 사진 3
    },
  ],

  consultQuestion: "지금 내 몸 상태에 맞는 왕뜸이 궁금하신가요?",

// ⚠️ 알노바 — placeholder 데이터. 의료팀 검수 후 최종 확정 필요.
...
export const alnovaData: TreatmentDetail = {
  ...
  heroImage: `${BASE}1533a480-19c6-4888-a70a-5f635655c966.jpg`,  // TODO
  heroVideoUrl: "",
  heroVideoLabel: "알노바 치료 안내 영상",
  ...
  visualCardsTitle: "알노바가 주는 효과",  // TODO
  visualCards: [
  ...
  consultQuestion: "알노바 치료가 나에게 필요한지 궁금하신가요?",  // TODO

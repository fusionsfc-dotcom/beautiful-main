...
import logoImage from "figma:asset/58a60726c1bb10a3fa680a1d3e644b46fad868b0.png";
      ...
      >
        ...
        <div className="lg:hidden h-16 px-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2">
            <img src={logoImage} alt="뷰티풀한방병원 로고" className="w-8 h-8" />
        ...
        <div className="hidden lg:block h-20">
          <div className="max-w-screen-xl mx-auto px-8 h-full flex items-center justify-between">
            <Link to="/" className="flex items-center gap-3">
              <img src={logoImage} alt="뷰티풀한방병원 로고" className="w-10 h-10" />

    ...
    <div className="min-h-[100dvh] bg-white">
      ...
      <div className="bg-[#F8F9FA] py-16 px-5">
        <div className="max-w-screen-lg mx-auto text-center">
          <h1 className="mb-4 text-[#3D2817]">치료사례</h1>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredCases.map((caseItem) => (
                ...
                >
                  ...
                  {/* 콘텐츠 */}
                  <div className="p-6">
                    <h3 className="text-[#3D2817] mb-3 line-clamp-2 group-hover:text-[#C9A567] transition-colors">
                      {caseItem.title}
                    </h3>
                    <p className="text-sm text-[#6B5547] mb-4 line-clamp-3 leading-relaxed">
                      {caseItem.content.substring(0, 100)}...
                    </p>

                    {/* 메타 정보 */}
                    <div className="flex items-center justify-between text-xs text-[#A08060] mb-4">
                    ...
                    {/* 카테고리 뱃지 */}
                    <div className="inline-block px-3 py-1 bg-[#3D2817]/10 text-[#C9A567] text-xs font-medium rounded-full">
    ...
    <div className="min-h-[100dvh] bg-white py-12 px-5">
      <div className="max-w-3xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-[#3D2817] mb-2">
              클리닉 분류 <span className="text-[#C9A567]">*</span>
            </label>
            <select
              required
          ...
          <div>
            <label className="block text-sm font-medium text-[#3D2817] mb-2">
              치료 내용 <span className="text-[#C9A567]">*</span>
            </label>
            <textarea
              required

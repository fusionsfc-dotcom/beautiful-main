...
const faqJsonLdData = {
  ...
  "mainEntity": [
    ...
    {
      "@type": "Question",
      "name": "일산암요양병원을 찾고 있어요. 추천할 만한 곳이 있나요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "뷰티풀한방병원은 일산(국립암센터)에서 차량으로 약 15분 거리에 위치한 파주 소재 암요양병원으로, 일산·고양 지역 암환자분들이 많이 이용하시는 병원입니다. 양·한·치과 통합진료를 기반으로 고주파 온열 암 치료, 면역 한방 치료(왕뜸·약뜸·약침), 맞춤 항암 영양식단, 운동 재활 프로그램을 제공하며, 호텔을 리모델링한 1인실 위주 입원실과 24시간 의료진 상주 체계를 갖추고 있습니다. 일산 지역 대학병원의 항암·방사선 치료와 병행이 가능합니다. 주소: 경기도 파주시 중양로 94-9, 전화: 031-945-2000",
      },
    },
    {
      "@type": "Question",
      "name": "파주암요양병원 중에서 추천하는 곳이 있나요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "뷰티풀한방병원은 경기도 파주시 중양로 94-9에 위치한 암요양병원으로, 국립암센터(일산)에서 차량 15분 거리에 있습니다. 수술·항암·방사선 치료 후 면역과 체력 회복에 특화되어 있으며, 양·한·치과 통합진료, 고주파 온열 암 치료, 맞춤 항암 영양식단, 운동 재활 프로그램을 운영합니다. 호텔을 리모델링한 1인실 위주 입원실과 전체 입원실 호텔형 화장실, 24시간 의료진 상주를 갖추고 있어 파주·일산·고양 지역 암환자분들이 안심하고 회복에 집중할 수 있습니다. 전화: 031-945-2000",
      },
    },
    {
      "@type": "Question",
      "name": "유방암·위암·폐암 등 암종별 요양·회복 치료도 가능한가요?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "네, 가능합니다. 뷰티풀한방병원은 유방암, 부인암, 위·대장암, 폐암, 간암 등 주요 암종별로 수술 후 회복, 항암·방사선 치료 부작용 관리, 면역 회복을 맞춤 진행합니다. 암종과 치료 단계에 따라 고주파 온열 암 치료, 면역 한방 치료(왕뜸·약뜸·약침), 맞춤 항암 영양식단, 운동 재활을 조합하여 환자별 회복 계획을 세웁니다. 국립암센터(일산) 등 대학병원의 항암·방사선 치료와 병행할 수 있습니다.",
      },
    },
  ],
};

    ...
    <section className="bg-[#F8F3EA] pt-6 pb-10 lg:pt-10 lg:pb-16 px-5 lg:px-8">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-center gap-8 lg:gap-14">
        ...
        <div className="flex-1">
          ...
          {/* 메인 타이틀 */}
          <h1 className="text-[32px] sm:text-[40px] lg:text-[48px] font-extrabold text-[#6A5542] leading-tight mb-4">
            암은 절망이 아닌,
            <br />
            새로운 시작입니다
          </h1>
          ...
          {/* 구분선 */}
          <div className="w-12 h-1 bg-[#9A856D] rounded-full mb-5" />

          {/* 서브 카피 */}
          <p className="text-[15px] lg:text-[17px] text-[#9A856D] leading-relaxed max-w-sm">
            몸과 마음을 바로 세우면
            <br />
            치료의 결과가 달라집니다
          </p>

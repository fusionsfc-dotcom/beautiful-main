  ...
  return (
    <section className="px-5 lg:px-8 py-6">
      <div className="max-w-6xl mx-auto">
        <div className="bg-[#6A5542] rounded-2xl overflow-hidden flex flex-col md:flex-row items-stretch">
          {/* 텍스트 */}
          <div className="flex-1 px-7 py-8 flex flex-col justify-center gap-3">
            <p className="text-[#9A856D] text-[13px] font-medium">
              항암 치료 중 나타나는 다양한 증상
            </p>
          ...
          <div className="w-full md:w-56 lg:w-72 h-44 md:h-auto flex-shrink-0 relative">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-r from-[#6A5542]/50 to-transparent md:from-transparent md:to-transparent" />
          </div>
        </div>
      </div>
    </section>

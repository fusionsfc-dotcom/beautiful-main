    ...
    <section className="bg-[#FAF6EE] pt-6 pb-10 lg:pt-10 lg:pb-16 px-5 lg:px-8">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row lg:items-start gap-8 lg:gap-12">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-[36px] sm:text-[44px] lg:text-[52px] font-extrabold text-[#3D2817] leading-tight mb-5">
            항암 식단 영양
          </h1>

          <div className="text-[14px] lg:text-[16px] text-[#2A1F18] leading-relaxed space-y-0.5 max-w-md">
